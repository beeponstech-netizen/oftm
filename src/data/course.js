      ...
      lessons: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'media', label: 'Exemples de screenshots de revenus (captures originales)', note: 'Captures à intégrer — voir images fournies' },
          ],
        },
        {
          id: 'objections',
      ...
      lessons: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'media', label: 'Organisation cross-reposting (Monday.com)', note: 'Capture à intégrer' },
          ],
        },
        {
          id: 'insta-v3',
